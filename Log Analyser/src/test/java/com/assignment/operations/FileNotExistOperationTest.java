...
public class FileNotExistOperationTest {

    @Test
    public void should_return_timeStamp_as_error_found() throws IOException {
    ...
    @Test
    public void should_not_return_timeStamp_as_no_error_found() throws IOException {
        String path = "C:/Users/User/Desktop/Log Analyser/src/main/resources/example.log";
        FileRead fileRead = new FileRead();
        Scanner scanner = fileRead.readFile(path);
